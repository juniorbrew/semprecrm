 ...
 *
 * Labels are English source keys — render them through the i18n layer
 * (t() from useLanguage, or the DOM translator) so the pt-BR copy lives in
 * src/lib/i18n*.ts alongside every other string.
 *
