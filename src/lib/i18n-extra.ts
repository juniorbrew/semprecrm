...
export const EN_TO_PT_EXTRA: Record<string, string> = {
  ...
  // Internal team chat (migration 038, module `internal_chat`)
  'Internal chat': 'Chat interno',
  'Chat': 'Chat',
  'Internal chat messages': 'Mensagens do chat interno',
  'When a teammate sends you a message in the internal chat and you do not have the conversation open.':
    'Quando um colega envia uma mensagem no chat interno e você não está com a conversa aberta.',
  ...
  'Yesterday': 'Ontem',
  'unread message': 'mensagem não lida',
  'unread messages': 'mensagens não lidas',
  'Pick a teammate on the left to start a conversation. Messages stay inside your account.':
    'Escolha um colega à esquerda para iniciar uma conversa. As mensagens ficam dentro da sua conta.',
  'Failed to load the chat': 'Não foi possível carregar o chat',
  'Failed to load messages': 'Não foi possível carregar as mensagens',
  'Failed to send the message': 'Não foi possível enviar a mensagem',
  'Could not open the conversation': 'Não foi possível abrir a conversa',
  // Internal team chat — phase 2 (migration 039): groups, attachments,
  // reactions, edit / delete
  'New group': 'Novo grupo',
  'Create group': 'Criar grupo',
  'Group name': 'Nome do grupo',
  'Pick the teammates for this group.': 'Escolha os colegas para este grupo.',
  'Select at least one member.': 'Selecione pelo menos um membro.',
  'Group created': 'Grupo criado',
  'Failed to create the group': 'Não foi possível criar o grupo',
  'Group': 'Grupo',
  'Groups': 'Grupos',
  'Search people and groups': 'Buscar pessoas e grupos',
  'Add members': 'Adicionar membros',
  'Everyone is already in this group.': 'Todos já estão neste grupo.',
  'Members added': 'Membros adicionados',
  'Failed to add members': 'Não foi possível adicionar membros',
  'Remove from group': 'Remover do grupo',
  'Member removed': 'Membro removido',
  'Failed to remove the member': 'Não foi possível remover o membro',
  'Leave group': 'Sair do grupo',
  'Leave this group? You will stop receiving its messages.':
    'Sair deste grupo? Você deixará de receber as mensagens dele.',
  'You left the group': 'Você saiu do grupo',
  'Failed to leave the group': 'Não foi possível sair do grupo',
  'Creator': 'Criador',
  ...
  'Pending': 'Pendente',
  'Nobody else in this group yet.': 'Ainda não há mais ninguém neste grupo.',
  ...
  'Uploading…': 'Enviando…',
  'Drop the file to attach it': 'Solte o arquivo para anexar',
  'File is too large (max 25 MB).': 'Arquivo muito grande (máx. 25 MB).',
  'File type not supported.': 'Tipo de arquivo não suportado.',
  'The file is empty.': 'O arquivo está vazio.',
  'Upload failed': 'Falha no envio',
  'Download': 'Baixar',
  'Open': 'Abrir',
  'Could not load the attachment': 'Não foi possível carregar o anexo',
  'Microphone access denied or unavailable.': 'Acesso ao microfone negado ou indisponível.',
  'React': 'Reagir',
  'Failed to react': 'Não foi possível reagir',
  'Edit message': 'Editar mensagem',
  'Delete message': 'Excluir mensagem',
  'Delete this message for everyone?': 'Excluir esta mensagem para todos?',
  'edited': 'editada',
  'Message deleted': 'Mensagem apagada',
  'Editing': 'Editando',
  'Failed to edit the message': 'Não foi possível editar a mensagem',
  'Messages can be edited for 15 minutes only': 'Mensagens só podem ser editadas por 15 minutos',
  'Failed to delete the message': 'Não foi possível excluir a mensagem',
  'Only the sender can delete a message': 'Só quem enviou pode excluir a mensagem',
  'Pick a teammate or a group on the left to start a conversation. Messages stay inside your account.':
    'Escolha um colega ou um grupo à esquerda para iniciar uma conversa. As mensagens ficam dentro da sua conta.',
  'are typing…': 'estão digitando…',
  'Manage members': 'Gerenciar membros',

  // Calendar (migration 040, module `calendar`)
  'Calendar': 'Agenda',
  'Month': 'Mês',
  'Week': 'Semana',
  'Day': 'Dia',
  'Previous': 'Anterior',
  'Whose appointments': 'Compromissos de quem',
  'appointment': 'compromisso',
  'appointments': 'compromissos',
  'more': 'mais',
  'more appointment': 'compromisso a mais',
  'more appointments': 'compromissos a mais',
  'New appointment': 'Novo compromisso',
  'Appointment': 'Compromisso',
  'Appointment title': 'Título do compromisso',
  'What is this appointment about?': 'Sobre o que é este compromisso?',
  'All day': 'Dia inteiro',
  'End': 'Fim',
  'The end must be after the start.': 'O fim deve ser depois do início.',
  'Times in': 'Horários em',
  'Location': 'Local',
  'Address, meeting room or video call link': 'Endereço, sala de reunião ou link da videochamada',
  'Agenda, context, what to prepare…': 'Pauta, contexto, o que preparar…',
  'Reminder': 'Lembrete',
  ...
  'No other members in this account.': 'Não há outros membros nesta conta.',
  'Accepted': 'Aceitou',
  'Declined': 'Recusou',
  'Accept': 'Aceitar',
  'Decline': 'Recusar',
  'Will you attend?': 'Você vai participar?',
  'You accepted this appointment': 'Você aceitou este compromisso',
  'You declined this appointment': 'Você recusou este compromisso',
  'You accepted the appointment': 'Você aceitou o compromisso',
  'You declined the appointment': 'Você recusou o compromisso',
  'Failed to save response': 'Não foi possível salvar a resposta',
  "Owner's color": 'Cor do responsável',
  'Schedule appointment': 'Agendar',
  'Schedule conflict': 'Conflito de horário',
  'already has an appointment at this time': 'já tem um compromisso neste horário',
  'Open task': 'Abrir tarefa',
  'Open chat': 'Abrir chat',
  'No conversation': 'Sem conversa',
  'No conversations with this contact': 'Nenhuma conversa com este contato',
  'No chat linked': 'Sem chat vinculado',
  'Direct chat': 'Conversa direta',
  'Search task by title': 'Buscar tarefa pelo título',
  "Also set the task's due date to the appointment start": 'Também definir o prazo da tarefa como o início do compromisso',
  'Created by': 'Criado por',
  'Cancelled': 'Cancelado',
  'Cancel appointment': 'Cancelar compromisso',
  'Restore': 'Restaurar',
  'Delete this appointment? This cannot be undone.': 'Excluir este compromisso? Isso não pode ser desfeito.',
  'Appointment created': 'Compromisso criado',
  'Appointment saved': 'Compromisso salvo',
  'Appointment cancelled': 'Compromisso cancelado',
  'Appointment restored': 'Compromisso restaurado',
  'Appointment deleted': 'Compromisso excluído',
  'Failed to create appointment': 'Não foi possível criar o compromisso',
  'Failed to save appointment': 'Não foi possível salvar o compromisso',
  'Failed to delete appointment': 'Não foi possível excluir o compromisso',
  'Failed to move appointment': 'Não foi possível mover o compromisso',
  'Failed to load appointments': 'Não foi possível carregar os compromissos',
  ...
  'Schedule from this message': 'Agendar a partir desta mensagem',
  'Today on the calendar': 'Hoje na agenda',
  'Your appointments for today': 'Seus compromissos de hoje',
  'Nothing scheduled today': 'Nada agendado para hoje',
  'Appointments you own or attend today show up here.': 'Os compromissos de hoje em que você é responsável ou participante aparecem aqui.',
  'Open calendar': 'Ver agenda',
